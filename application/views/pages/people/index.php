            ...
            <form class="form-horizontal" id="form-add" novalidate>
              ...
              <div class="box-body" style="min-height:400px">
                ...
                <div class="form-group" v-validate-class>
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" id="gender" name="gender" v-model="gender" initial="off" v-validate:gender="ruleGender">
                      <option value="">--Select a gender--</option>
                      <option value="Male">Male</option>
                      <option value="Female">Female</option>
                    </select>
                    <p class="text-red" v-if="$validation.gender.required">{{$validation.gender.required}}</p>
                  </div>
                </div>
                <div class="form-group" v-validate-class>
